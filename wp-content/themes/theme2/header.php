...
<link rel="stylesheet" type="text/css" href="<? bloginfo('template_url');?>/css/elastislide.css" />
<link rel="stylesheet" type="text/css" href="<? bloginfo('template_url');?>/css/custom.css" />
<script src="<? bloginfo('template_url');?>/js/modernizr.custom.17475.js"></script>
<!--[if gte IE 9]>
  <style type="text/css">
    .gradient {
       filter: none;
